...
<header class="header">
  ...
  <div style="height:60px;">------------</div>
      ...
      <form action="coursesController" method="post">
         ...
         <div class="form-row">        
           	<div class="input-data">
	               <input type="text" name="category" style="width:320px;" required>
	               <div class="underline"></div>
	               <label for="">Category</label>
	         </div>
            <div class="input-data">
               <input type="text" name="description" style="width:320px;"  required>
               <div class="underline"></div>
         ...
         <div class="form-row"> 
	         <div class="input-data">
               <input type="text" name="duration" style="width:320px;" required>
               <div class="underline"></div>
