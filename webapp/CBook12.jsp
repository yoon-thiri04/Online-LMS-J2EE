...
<!-- About Java -->
    <div id="ja">
	    <div id="javatext">
	    	<h1>C#</h1>
	    	<p>
	    		 C# is a versatile programming language developed by Microsoft, widely used for building desktop, web, mobile, and gaming applications. With features like garbage collection and type safety, C# allows developers to write efficient code. Its syntax, similar to C and Java, makes it easy to learn.
	    	</p><br><br>
	    </div>
    </div>
   <div class="mainmain">
