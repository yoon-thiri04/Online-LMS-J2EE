...
<%@page import="dao.lectureDAO" import ="dao.courseDAO" import="dao.UserDAO"
...
<!-- About Java -->
    <div id="ja">
	    <div id="javatext">
	    	<h1>CSS</h1>
	    	<p>
	    		CSS (Cascading Style Sheets) is a style sheet language used to define the presentation and layout of HTML documents. It allows web developers to control the appearance of web pages, including elements such as fonts, colors, spacing, positioning, and decorative features.
	    	</p><br><br>
	    </div>
    </div>
   <div class="mainmain">
...
try {
    ...
    String courseQuery = "SELECT course_id FROM courses WHERE category='CSS'";
