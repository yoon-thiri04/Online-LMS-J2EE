...
courses = lecturerdao.get1("Java Script");
...
<script>function enroll(course_id) {
...
<!-- About Java -->
    <div id="ja">
	    <div id="javatext">
	    	<h1>JavaScript</h1>
	    	<p>
	    		JavaScript is a high-level, interpreted programming language primarily used for front-end web development. It allows developers to add interactivity, dynamic behavior, and functionality to web pages. JavaScript is an essential component of modern web development, alongside HTML (Hypertext Markup Language) and CSS (Cascading Style Sheets).
	    	</p><br><br>
	    </div>
    </div>
   <div class="mainmain">
...
try {
    ...
    String courseQuery = "SELECT course_id FROM courses WHERE category='Java Script'";
